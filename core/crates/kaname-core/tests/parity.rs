...
const CASES: &[Case] = &[
    Case {
        ...
        expected_issuer_id: "ICICI_AMAZONPAY_CARD",
    },
    Case {
        label: "HDFC year-end",
        parse: read_hdfc_statement,
        rel_path: "hdfc/credit_card/year_end.json",
        expected_issuer_id: "HDFC_SWIGGY_CARD",
    },
    Case {
        label: "HDFC monthly",
        parse: read_hdfc_statement,
