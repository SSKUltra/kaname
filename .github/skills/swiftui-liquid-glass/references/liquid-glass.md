<!-- Vendored from https://github.com/Dimillian/Skills (swiftui-liquid-glass), MIT licensed.
Kaname targets iOS 26.0 unconditionally: ignore any availability-gating or fallback advice
below or in upstream — see SKILL.md. -->
